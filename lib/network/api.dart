...
//192.168.41.224
  ...
  static const profileSettingDefaultFeedUpdate =
      'settings/profileSettingDefaultFeedUpdate';
  ...
  //admin
  static const getAllUser = 'profile/getAllUser';
  static const getAllReport = 'profile/getAllReport';
  static const deleteUser = 'profile/deleteUser';
  static const deleteFeed = 'profile/deleteFeed';
  static const deleteReport = 'profile/deleteReport';
 ...
 // static const worldFeed = 'feed/getFeed?feed_type=world';
  ...
  /// reactions
  static feedReactedUsers(feedId, {reactionType = 'all', lastId = ''}) =>
      'feed/getReactedPeople?id=$feedId&reaction=$reactionType&more=$lastId';
  ...
  static feelingActivitysearch({String type = "", String str = ""}) =>
      'feed/searchForFeelings?type=$type&str=$str';
  static feelingSubActivitysearch({String str = "", dynamic id = ""}) =>
      'feed/searchForSubActivities?str=$str&id=$id';

  //search
  static search(String str, {String tab = 'feed'}) =>
      'group/globalSearch?str=$str&tab=$tab';
  ...
  static feedCommentReplies(int id, {int? lastId}) =>
      'comment/getReply/$id?more=$lastId';
  ...
  static commentReactionTypes(commentId) =>
      'comment/getAllReactionType?id=$commentId';
  ...
  static const memberSearchForCreateGroupChat =
      'profile/getFriendListsBySearch';
  static conversationSearch(str) => 'profile/getPeopleListBySearch?str=$str';
  static conversationGroupPeopleSearch(str) =>
      'chatting/getInboxGlobalSearch?str=$str';
  ...
  static searchForGroupMember({String str = "", int? id}) =>
      'chatting/searchForGroupMember?str=$str&id=$id';
  ...
  // profile
  static profileDetails(String userName, {int? lastId, String tab = 'feed'}) =>
      'profile/getProfile?tab=$tab&user=$userName&more=$lastId';
  static const updateBasicProfile = 'profile/saveName';
  static const updateUserPic = 'profile/uploadUserPic';

  // page
  static pageDetails(String pageName, {int? lastId, String tab = 'feed'}) =>
      'page/getPageDetails?tab=$tab&user=$pageName&more=$lastId';
  static pages({String tab = "", int page = 1}) =>
      'page/getAllPage?tab=$tab&limit=20&page=$page';
  ...
  // group
  static groups({String tab = "", int page = 1}) =>
      'group/getGroupList?tab=$tab&limit=20&page=$page';
  static groupDetails(String groupName, {lastId, String tab = 'feed'}) =>
      'group/getSingleGroup?tab=$tab&slug=$groupName&more=$lastId';
  static groupPendingMember({dynamic grpId = ""}) =>
      'group/allRequest?group_id=$grpId';
  ...
  static invitedMemberListGroup(int groupId) =>
      'group/getFriendNotGroupMember?group_id=$groupId';
  static searchMemberGroup(int groupId, String search) =>
      'group/getSearchFriend?str=$search&group_id=$groupId';

  /// event
  static const createEvent = 'event/createEvent';
  static const editEvent = 'event/editEvent';
  static eventDetails(String eventName, {lastId, String tab = 'feed'}) =>
      'event/getEventDetails?tab=$tab&event=$eventName&more=$lastId';
  static events({String tab = "", int page = 1}) =>
      'event/getAllEvent?tab=$tab&limit=20&page=$page';
  ...
  // friends
  static friendRequests({int page = 1}) =>
      'profile/getFriendRequests?page=$page';
  static allFriends({int page = 1}) =>
      'profile/getFriendListsForChat?page=$page';
  ...
  static courseByCategory({categoryName, limit = 10}) =>
      'course/get/$categoryName?limit=$limit';
