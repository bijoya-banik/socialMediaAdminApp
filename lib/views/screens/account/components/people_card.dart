...
class PeopleCard extends ConsumerStatefulWidget {
  ...
  final PeopleModel friendData;

  const PeopleCard({Key? key, required this.type, required this.friendData})
      : super(key: key);
                                  ...
                                  Expanded(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        ...
                                        Text(widget.friendData.email??"",
                                        style: KTextStyle.bodyText3.copyWith(fontSize: 13, color: KColor.black87))
                                      ],
                                    ),
                                  ),
                                ],
